...
Existuje 6 úrovní delenia automatizovanej jazdy.\cite{understanding-av}\cite{trevor} Tieto úrovne sa delia do dvoch skupín, kde prevažne človek monitoruje prostredie jazdy a kde prevažne systém monitoruje prostredie jazdy. 
...
\centering
\caption{Tabuľka úrovní delenia automatizovanej jazdy\cite{understanding-av}}
\end{figure}
...
\paragraph{Adaptívny tempomat}\cite{ADAS}je najmä užitočný na diaľnici. Tento systém sleduje svoju rýchlosť a rýchlosť ostatných vozidiel na dialnici na neobmedzenú dobu, kde človeku to robí problém po pár minútach. Aplikácia dokáže zrýchliť, spomaliť a vie aj zastaviť vozidlo v závislosti od akcií iných objektov v bezprostrednej blízkosti.
\paragraph{Diaľkové a pixelové svetlo bez oslnenia}\cite{ADAS}využíva senzory na prispôsobenie sa tme a okoliu vozidla bez rušenia protiidúcich vozidiel. Táto nová aplikácia svetlometov zisťuje, že či sa vyskytujú oproti autu svetlá iných vozidiel a presmeruje svetlá vozidla preč. Vďaka tomuto úkonu zabráni dočasnému oslepeniu ostatných účastníkov cestnej premávky.
\paragraph{Adaptívne ovládanie svetiel}\cite{ADAS}...
\paragraph{Autonómne parkovanie}\cite{ADAS} je nová technológia, ktorá funguje prostredníctvom sieťovania senzorov vozidla, sieťovej komunikácie 5G, s cloudovými službami, ktoré spravujú autonómne vozidlá na parkoviskách. Senzory vozidiel poskytujú vozidlu informácie o tom, kde sa nachádza, kam musí ísť a ako sa tam bezpečne dostať. Všetky tieto informácie sú metodicky vyhodnocované a používané pri akcelerácii jazdy, brzdení a riadení až do bezpečného zaparkovania vozidla.
\paragraph{Navigačný systém}\cite{ADAS}...
\paragraph{Nočné videnie}\cite{ADAS}...
\paragraph{Monitorovanie slepého bodu}\cite{ADAS}...
\paragraph{Automatické núdzové brzdenie}\cite{ADAS}...
\paragraph{Detekcia ospalosti vodiča}\cite{ADAS}...
\paragraph{Systém monitorovania vodičov}\cite{ADAS}...
